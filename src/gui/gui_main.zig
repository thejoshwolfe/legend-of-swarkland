                        ...
                        while (cursor.x < render_bounding_box.right()) : (cursor.x += 1) {
                            ...
                            render_floor: {
                                const floor_texture = switch (cell.floor) {
                                    ...
                                    .sandstone => selectAesthetic(textures.sprites.sandstone_floor[0..], aesthetic_seed, cursor),
                            ...
                            render_wall: {
                                const wall_texture = switch (cell.wall) {
                                    ...
                                    .sandstone => selectAesthetic(textures.sprites.sandstone_wall[0..], aesthetic_seed, cursor),
