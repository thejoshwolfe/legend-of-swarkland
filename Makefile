...
OBJECTS = build/main.o build/swarkland.o build/display.o build/load_image.o build/util.o build/individual.o build/string.o build/path_finding.o build/map.o build/hashtable.o build/random.o
